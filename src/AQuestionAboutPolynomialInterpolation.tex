...
\title[A question about Polynomial Interpolation]
...
\date{\today}
\hypersetup{
    pdftitle={A question about Polynomial Interpolation},
    pdfsubject={
        Your Subject List
    },
...
\begin{document}
    ...
    \freefootnote{Sources: \url{https://github.com/kolosovpetro/AQuestionAboutPolynomialInterpolation}}
    ...
    \bibliography{AQuestionAboutPolynomialInterpolation}
